...
def digital_assistant(data):
    if "repeat" in data or "say" in data:
        listening = True
        count = 0
        wordstring = ''
        for word in data:
    ...
    elif "hello" in data or "hi" in data or "yo" in data or 'high' in data:
        listening = True
    ...
    elif "system" in data and "shutdown" in data:
    ...
    elif "never" in data and "gonna" in data and "give" in data and "you" in data and "up" in data:
        respond("Ok, here we go.")
        playsound("aolaeasteregg.wav")
        respond("Your welcome.")
